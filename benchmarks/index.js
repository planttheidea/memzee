...
const lru = require("lru-memoize").default;
const mem = require("mem");
const memoizee = require("memoizee");
const memoizerific = require("memoizerific");
const memoizeOne = require("memoize-one");
const memzee = require("../dist/memzee").default;
...
const singularPrimitive = {
  ...
  "lru-memoize": lru(1)(fibonacciSinglePrimitive),
  ...
  memzee: memzee(fibonacciSinglePrimitive),
  moize: moize.simple(fibonacciSinglePrimitive),
...
const singularArray = {
  ...
  "lru-memoize": lru(1)(fibonacciSingleArray),
  ...
  memzee: memzee(fibonacciSingleArray),
  moize: moize.simple(fibonacciSingleArray),
...
const singularObject = {
  ...
  "lru-memoize": lru(1)(fibonacciSingleObject),
  ...
  memzee: memzee(fibonacciSingleObject),
  moize: moize.simple(fibonacciSingleObject),
...
const multiplePrimitive = {
  ...
  "lru-memoize": lru(1)(fibonacciMultiplePrimitive),
  ...
  memzee: memzee(fibonacciMultiplePrimitive),
  moize: moize.simple(fibonacciMultiplePrimitive),
...
const multipleArray = {
  ...
  "lru-memoize": lru(1)(fibonacciMultipleArray),
  ...
  memzee: memzee(fibonacciMultipleArray),
  moize: moize.simple(fibonacciMultipleArray),
...
const multipleObject = {
  ...
  "lru-memoize": lru(1)(fibonacciMultipleObject),
  ...
  memzee: memzee(fibonacciMultipleObject),
  moize: moize.simple(fibonacciMultipleObject),
